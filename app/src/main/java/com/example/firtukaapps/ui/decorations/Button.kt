package com.example.firtukaapps.ui.decorations
...
class Button : AppCompatButton {
    ...
    private fun init() {
        ...
        enableBackground = ContextCompat.getDrawable(context, R.drawable.button) as Drawable
        disabledBackground = ContextCompat.getDrawable(context, R.drawable.button_dissable) as Drawable
    }
